<template>
  <div class="main">
    <section class="mAd">
      <img :src="dataInfo.head_ima" alt="华网文学"/>
      <div v-if="!dataInfo.head_ima" class="mLoad"><img src="./../assets/images/mLoad.gif" alt="加载中..." /></div>
    </section>
    ...
    <section class="mContent_w">
      <div class="mModule mGoodBook_w">
        <div class="mGoodBookL">
          ...
          <div v-if="!dataInfoBookList.book_id" class="mLoad"><img src="./../assets/images/mLoad.gif" alt="加载中..." /></div>
        </div>
      ...
      <div class="mModule">
        <h3 v-if="dataInfoFirstChannelData.category_name" class="mModuleTi">{{ dataInfoFirstChannelData.category_name }}</h3>
        <ul v-if="dataInfoFirstChannelData.category_name" class="mModuleList">
        ...
        <div v-if="!dataInfoFirstChannelData.category_name" class="mLoad"><img src="./../assets/images/mLoad.gif" alt="加载中..." /></div>
      </div>
      <div class="mModule">
        <h3 v-if="dataInfoSecondChannelData.category_name" class="mModuleTi">{{ dataInfoSecondChannelData.category_name }}<router-link :to="'/classifylist?id='+dataInfoSecondChannelData.category_id">查看更多 &gt;</router-link></h3>
        <ul v-if="dataInfoSecondChannelData.category_name" class="mModuleList">
        ...
        <div v-if="!dataInfoSecondChannelData.category_name" class="mLoad"><img src="./../assets/images/mLoad.gif" alt="加载中..." /></div>
      </div>
      <div class="mModule">
        <h3 v-if="dataInfoThirdChannelData.category_name" class="mModuleTi">{{ dataInfoThirdChannelData.category_name }}<router-link :to="'/classifylist?id='+dataInfoThirdChannelData.category_id">查看更多 &gt;</router-link></h3>
        <ul v-if="dataInfoThirdChannelData.category_name" class="mModuleLista">
        ...
        <div v-if="!dataInfoThirdChannelData.category_name" class="mLoad"><img src="./../assets/images/mLoad.gif" alt="加载中..." /></div>
      </div>
    </section>
  </div>
</template>
...
<style scoped>
.mAd{width:10rem;margin:0 auto;display:block;overflow:hidden;}
